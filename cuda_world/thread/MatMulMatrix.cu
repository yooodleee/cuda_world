...
int main(int argc, char* argv[]) {
	...
	timer.setTimerName(3, (char*)" - [Data transfer] host->device");
	timer.setTimerName(4, (char*)" - [Data transfer] device->host");
...
template<class T> void allocNinitMem(T** p, long long size, double* memUsage) {
	*p = new T[size];
